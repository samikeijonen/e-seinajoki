...
var project      = 'e-seinajoki'; // Project name.
var build        = './build/e-seinajoki/';
var buildInclude = [
    '**',
    '!node_modules/**/',
    '!assets/sass/**/*',
...
gulp.task('browsersync', function() {
  ...
  browserSync.init(files, {
    proxy: "localhost/foxland-themes/e-seinajoki",
...
gulp.task('clean:unneccessary', function() {
	return del(['./build/e-seinajoki/node_modules/**/*', './build/e-seinajoki/build/**/*'])
});
